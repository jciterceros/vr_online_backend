...
@Component
public class PagamentoNotificarFactory {
    ...
    @Autowired
    public PagamentoNotificarFactory(PagamentoPIX pagamentoPIX, PagamentoBoleto pagamentoBoleto, PagamentoCartao pagamentoCartao, PagamentoBitcoins pagamentoBitcoins) {
    ...
    public IPagamentoNotificar getPagamentoNotificar(TipoPagamento tipoPagamento) {
